 ...
 * /api/auth/login:
 *   post:
 *     summary: Fazer login (tutor ou funcionário)
 *     tags: [Authentication]
 *     requestBody:
 *       required: true
 *       content:
